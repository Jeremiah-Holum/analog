...
VO = {
    ...
    "D02": ("dale", "This is Dale Kessler, night security at Brenner Mutual. It's November third. About two in the morning."),
    ...
    "W02": ("dale", "Maintenance came out twice. They say the ballasts are fine. The wiring is fine."),
    ...
    "X04": ("dale_q", "Hello?"),
    "X05": ("dale_q", "Building's closed. Is somebody in there?"),
    # TAPE 2
    "S01": ("dale", "November seventh."),
    "S02": ("dale", "Pruitt says there is no tenth door. He says I can't count."),
    "S03": ("dale", "So. I'm counting."),
    "S04": ("dale_q", "That's not right. This hall isn't this long."),
    "F01": ("dale_q", "Hey."),
    "F02": ("dale", "Hey! This floor's closed. You can't be up here."),
    "F03": ("dale_q", "Where did he go?"),
    # TAPE 4 - desk
    "P01": ("dale_q", "November ninth."),
    "P02": ("dale_q", "I called Pruitt. About the man. He asked me what number I got to."),
    "P03": ("dale_q", "I said fourteen. He didn't say anything for a long time."),
    ...
    "G03": ("dale_q", "Okay. Okay. I'm just going to look."),
